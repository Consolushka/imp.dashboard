...
<template>
  <article class="bg-surface-white border-2 border-primary shadow-[4px_4px_0px_0px_rgba(28,27,27,1)] hover:-translate-y-1 hover:translate-x-1 hover:shadow-[8px_8px_0px_0px_rgba(28,27,27,1)] transition-all duration-150 flex flex-col">
    ...
    <div class="p-lg pt-0">
      <button class="w-full bg-secondary-container text-white font-label-caps py-md transition-all border-2 border-primary uppercase tracking-wider font-bold shadow-[4px_4px_0px_0px_rgba(28,27,27,1)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none cursor-pointer hover:bg-secondary">
        VIEW TOURNAMENT
      </button>
    </div>
  </article>
